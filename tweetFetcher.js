...
window.tweetFetcher = (() => {
    ...
    function createTweetElement(tweet) {
        ...
        // NEW: Simpler and more reliable check for whether the current user liked the tweet.
        let userHasLiked = false
        if (window.connectedAddress) {
            // Create a Set of lowercase liker addresses for case-insensitive comparison
